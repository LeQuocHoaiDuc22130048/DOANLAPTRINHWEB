          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Gucci chính hãng: Giá bán, mẫu mới, tư vấn mua
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_gucci_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Gucci là biểu tượng thời trang hàng đầu nước Ý. Với thiết kế
                    tinh tế và độc đáo, Gucci mang đến sự kết hợp hoàn hảo giữa
                    thời trang và chất lượng. Vật liệu cao cấp như Acetate và
                    hợp kim được sử dụng để tạo ra những cặp kính đẹp mắt và bền
                    bỉ. Sự đa dạng về kiểu dáng, từ cổ điển đến hiện đại, đáp
                    ứng mọi sở thích và phong cách cá nhân, với mắt kính Gucci,
                    bạn sẽ tự tin và nổi bật trong mọi dịp.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_gucci" class="product-ordering" method="get">
