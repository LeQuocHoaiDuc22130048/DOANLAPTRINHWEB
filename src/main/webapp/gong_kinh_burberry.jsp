...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Gọng kính Burberry</title>
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Burberry chính hãng, hàng hiệu, mẫu mới nhất
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_burberry_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Burberry – biểu tượng của Anh Quốc, là hãng thời trang tôn
                    thờ sự cổ điển, phong cách này cũng là nền tảng cho mọi sản
                    phẩm mà hãng chế tác. Mắt kính cũng không ngoại lệ, khoác
                    lên mình những họa tiết quen thuộc, kính Burberry không chỉ
                    giúp nâng tầm phong cách mà còn mang đến sự sang trọng khó
                    cưỡng của nét đẹp đương đại. Khám phá bộ sưu tập kính bất
                    bại của nhà Burberry.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_burberry" class="product-ordering" method="get">
