            ...
            <div class="col-12">
              <nav class="main-nav">
                ...
                <ul class="nav">
                  ...
                  <li class="scroll-to-section">
                    <a href="#" class="active">Tròng kính</a>
                    <div class="sub-menu nav-dropdown">
                      <div id="col-142015409" class="col medium-6 large-6">
                        <div class="col-inner">
                          <div id="text-2480338525" class="text">
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Tròng kính chính hãng: Giá, Tư vấn cắt tròng theo nhu cầu
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/trong-kinh-chinh-hang-banner.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Ngày nay, thị trường đang cung cấp đa dạng các loại tròng
                    kính cận, loạn, viễn tốt trong việc điều chỉnh tật khúc xạ.
                    Không chỉ là giải pháp hỗ trợ thị lực hiệu quả, sản phẩm còn
                    đi kèm những tính năng ưu việt như chống tia UV, ánh sáng
                    xanh, đổi màu, chống chói… Dù vấn đề tật khúc xạ của bạn là
                    gì và có nhu cầu cao trong việc bảo vệ thị lực như thế nào
                    thì tròng kính cao cấp, chính hãng đều có thể đáp ứng.
                  </em>
                </p>
              </div>
              <div class="shop-container section-title-container">
                <h3 class="section-title section-title-center">
                  <b></b>
                  <span class="section-title-main">Loại Tròng</span>
                  <b></b>
                </h3>
              </div>
                ...
                <tbody>
                  <tr style="height: 95px">
                    <td style="width: 33, 3%; height: 95px; text-align: center">
                      <a
                        title="Kính đơn tròng"
                        href="trong_kinh_don_trong.html"
                      >
                        <img
                          src="assets/images/bst-kinh-don-trong-banner.jpg"
                          alt=""
                          width="340"
                          height="210"
                    ...
                    <td style="width: 33, 3%; height: 95px; text-align: center">
                      <a
                        title="Kính hai tròng"
                        href="trong_kinh_hai_trong.html"
                      >
                        <img
                          src="assets/images/bst-kinh-hai-trong-banner.jpg"
                          alt=""
                          width="340"
                          height="210"
                          class="alignnone wp-image-19677 size-full"
                    ...
                    <td style="width: 33, 3%; height: 95px; text-align: center">
                      <a title="Kính đa tròng" href="trong_kinh_da_trong.html">
                        <img
                          src="assets/images/bst-kinh-da-trong-banner.jpg"
                          alt=""
                          width="340"
                          height="210"
                          class="alignnone wp-image-19677 size-full"
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_trong_kinh" class="product-ordering" method="get">
