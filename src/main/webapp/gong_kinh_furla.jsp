          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Furla nam, nữ chính hãng – Mẫu mới, giá, tư vấn mua
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_furla_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Furla thương hiệu thời trang nữ đình đám đến từ Ý. Không chỉ
                    nổi danh ở sứ xở thơ mộng, hãng còn tiến xa hơn ra thị
                    trường Châu Á, trong đó có Việt Nam. Với thiết kế thanh
                    lịch, tao nhã kính Furla mỗi khi trình làng đều làm điêu
                    đứng trái tim các quý cô. Không chỉ mang đến sản phẩm chất
                    lượng mà Furla còn là phụ kiện nâng tầm vẻ kiêu sa cho các
                    chị em sở hữu. Điểm danh các sản phẩm mắt kính hàng hiệu,
                    chất lượng đến từ Furla dưới đây!
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_furla" class="product-ordering" method="get">
