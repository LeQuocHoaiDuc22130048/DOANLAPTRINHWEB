...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Gọng kính kim loại</title>
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    300+ Gọng kính kim loại nam, nữ bền đẹp, thời trang
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner-gong-kinh-kim-loai.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Gọng kính kim loại được yêu thích nhờ vẻ đẹp sang trọng và
                    tinh tế. Chất liệu kim loại cao cấp mang đến độ bền vượt
                    trội, khả năng chống va đập tốt và dễ dàng điều chỉnh để phù
                    hợp với mọi khuôn mặt. Từ vẻ đẹp cổ điển, quý phái của vàng
                    đến titanium sáng bóng mang đến sự hiện đại, trẻ trung. Gọng
                    kính kim loại đáp ứng mọi phong cách thời trang, từ tối
                    giản, thanh lịch đến cá tính, nổi bật. Dù là bất kỳ ai, bạn
                    đều có thể tìm thấy kính cận kim loại hoàn hảo để tôn lên vẻ
                    đẹp riêng của mình.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_kimloai" class="product-ordering" method="get">
