...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Gọng kính EyesCloud</title>
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Gong kính Eyes Cloud nam, nữ thời trang, siêu bền nhẹ
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_eyescloud_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Eyescloud thương hiệu kính hàng đầu đến từ Nhật Bản. Sản
                    phẩm làm từ nhựa dẻo Ultem, mang đến chiếc kính nhẹ, bền và
                    siêu đàn hồi. Bạn có thể bất ngờ khi vì độ dẻo của chúng khi
                    bẻ ngược ra sau và sản phẩm tự quay về hình thái ban đầu,
                    nguyên vẹn. Kết hợp cùng trọng lượng trung bình 7,0g, kính
                    Eyescloud là gọng kính hoàn hảo để bạn đeo cả ngày dài mà
                    không phải lo lắng sự thoải mái
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_eyescloud" class="product-ordering" method="get">
...
<%--    <script src="assets/js/cart.js"></script>--%>
    ...
    <csript src="assets/js/hien_thi_ten_dangnhap.js"></csript>
