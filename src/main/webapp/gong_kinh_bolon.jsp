          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Bolon nam, nữ chính hãng, đủ màu đủ kiểu
                  </span>
                </strong>
              </h1>
              <p>
              ...
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Bolon thương hiệu mắt kính ra đời vào năm 2003 tại Pháp. Dù
                    “sinh sau đẻ muộn” so với các đàn anh cùng ngành. Nhưng bằng
                    nỗ lực và cố gắng không ngừng hãng đã lọt TOP 5 thương hiệu
                    kính mắt tại Châu Á Thái Bình Dương. Hơn hẳn một thương hiệu
                    kính, nhà mốt luôn cố gắng truyền tải thông điệp sống tích
                    cực đến người tiêu dùng qua “Bold Like You” hãy là chính
                    mình, dám nghĩ, dám thực hiện. Sở hữu một chiếc kính Bolon
                    không chỉ trải nghiệm hoàn hảo về thời trang mà bạn còn mang
                    lên mình một làn sóng mới của công nghiệp kính mắt.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_gkbolon" class="product-ordering" method="get">
                        ...
                        <div class="thumb">
                          <div class="hover-content">
                            <ul>
                              ...
                              <!-- Thêm vào giỏ hàng -->
                              <li>
                                <a href="#" class="btn_gio_hang" data-id="${product.id}"><i class="fa fa-shopping-cart"></i></a>
                              </li>
                            </ul>
                          </div>
