...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Tròng kính essilor</title>
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Tròng kính Essilor (Pháp) chính hãng: Giá, đánh giá, tư vấn
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner-thuong-hieu-essilor.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Essilor là thương hiệu “tròng kính số 1 thế giới”, sở hữu hàng ngàn công nghệ độc quyền cùng hàng trăm sản phẩm chất lượng, tròng kính Essilor luôn là ưu tiên hàng đầu của người mua kính. Không chỉ điều chỉnh tật khúc xạ, kính Essilor còn cung cấp nhiều tính năng đi kèm như chống lóa, đổi màu, hạn chế trầy xước và giúp giảm mỏi hiệu quả. Khám phá những danh mục sản phẩm nổi trội của Essilor dưới đây!
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_trong_essilor" class="product-ordering" method="get">
