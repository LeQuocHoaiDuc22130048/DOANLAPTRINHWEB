...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Gọng kính Daniel wellington</title>
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Daniel Wellington nam, nữ thời trang, chính hãng
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/banner_daniel_wellington_brand.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính Daniel Wellington mang đến vẻ đẹp tối giản, thanh lịch
                    và hiện đại. Với thiết kế tinh tế, tập trung vào sự đơn giản
                    và tinh tế, kính mắt DW dễ dàng phối hợp với nhiều phong
                    cách thời trang khác nhau. Thương hiệu này được ưa chuộng
                    bởi giới trẻ nhờ vào sự trẻ trung, năng động và không kém
                    phần sang trọng. Từ những mẫu kính mát kim loại mảnh mai đến
                    những thiết kế acetate cổ điển, kính Daniel Wellington luôn
                    toát lên vẻ đẹp thanh lịch và hiện đại. Đây là lựa chọn hoàn
                    hảo cho những ai tìm kiếm một chiếc kính đơn giản, tinh tế
                    nhưng vẫn thể hiện được phong cách riêng.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_daniel" class="product-ordering" method="get">
