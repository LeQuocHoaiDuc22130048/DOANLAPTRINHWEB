          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Prada nam, nữ chính hãng, mẫu mới thời trang
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_prada_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Nếu bạn đang tìm kiếm sự kết hợp tuyệt vời giữa tay nghề thủ
                    công đến từ Ý và thiết kế mang tính tiên phong, kính Prada
                    là sự lựa chọn hoàn hảo. Không chỉ nổi tiếng về các bộ sưu
                    tập táo bạo về thời trang, bộ sưu tập kính mắt Prada cũng
                    không ngoại lệ. Tinh tế, thanh lịch và cổ điển, mọi gọng
                    kính Prada đều trung thành với tinh thần di sản ấy.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_prada" class="product-ordering" method="get">
