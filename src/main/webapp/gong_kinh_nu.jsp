          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    300+ Gọng kính cận nữ đẹp, hàng hiệu hợp mọi khuôn mặt
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner-gong-kinh-can-nu.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Gọng kính cận nữ không chỉ là phụ kiện hỗ trợ thị lực mà còn
                    là món đồ tôn lên đường nét của gương mặt. Một chiếc kính
                    phù hợp giúp phái nữ che đi những khuyết điểm và nâng tầm
                    phong cách mang đến sự tự tin đáng kể cho các quý cô. Để
                    thêm năng động và cá tính có thể thử qua kính gọng mắt mèo,
                    nửa viền hay oversized. Đối với những cô gái văn phòng thì
                    khung chữ nhật không viền là tương xứng nhất, mang đến diện
                    mạo thanh lịch khó cưỡng.
                  </em>
                </p>
              </div>
              ...
              <p class="tag-in-category">
                ...
                <a href="" title="Gọng kính cận thể thao"> Gọng kim loại nữ</a>
                <a href="" title="Gọng kính giá rẻ">Gọng nữ trong suốt</a>
                <a href="" title="Gọng kính cận màu đen">Gọng nữ không viền</a>
                <a href="" title="Gọng kính cận màu trắng">Gọng nữ tròn</a>
                <a href="" title="Gọng kính cận màu nâu">Gọng nữ giá rẻ</a>
              </p>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_nu" class="product-ordering" method="get">
