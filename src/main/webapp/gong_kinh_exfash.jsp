          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Exfash nam, nữ chính hãng, mẫu mới thời trang
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_exfash_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính Exfash đến từ Hàn Quốc mang đến làn gió mới với phong
                    cách thời trang trẻ trung, năng động và hợp xu hướng. Thương
                    hiệu này nhanh chóng chiếm được cảm tình của giới trẻ nhờ
                    thiết kế đa dạng. Kính mắt Exfash chú trọng đến chất lượng
                    và chi tiết, sử dụng chất liệu cao cấp, bền bỉ và an toàn
                    cho người sử dụng. Mức giá phải chăng cũng là một điểm cộng
                    lớn, giúp Exfash tiếp cận được nhiều đối tượng khách hàng.
                    Với Exfash, bạn có thể dễ dàng tìm thấy một chiếc kính phù
                    hợp với phong cách và cá tính riêng, từ dịu dàng, nữ tính
                    đến cá tính, nổi bật.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_exfash" class="product-ordering" method="get">
