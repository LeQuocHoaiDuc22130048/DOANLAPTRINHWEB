        ...
        <div class="shop-container">
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              ...
              <p>
                <img src="assets/images/banner_dior_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Dior thương hiệu cao cấp đến từ Pháp, đã ghi dấu ấn mạnh mẽ
                    trong lòng giới mộ điệu nhờ vào kỹ thuật chế tác chuyên biệt
                    của mình. Bước chân vào lĩnh vực thời trang năm 1946, cho
                    đến nay hãng đã trở thành một trong TOP 10 biểu tượng thời
                    trang xa xỉ. Lĩnh vực mắt kính Dior luôn thu hút tín đồ phụ
                    kiện xuống tay chi mạnh ngay từ mẫu “demo”. Bởi tuyệt tác
                    của nhà mốt Pháp luôn có một chất riêng khó tả, mang đến
                    đẳng cấp cao quý nêu bật lên phong thái người sở hữu.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_dior" class="product-ordering" method="get">
