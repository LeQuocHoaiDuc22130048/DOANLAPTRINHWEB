          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Molsion chính hãng, gọng cận thời trang, mẫu mới
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_molsion_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Molsion “đứa con tinh thần” thuộc tập đoàn Essilor danh
                    tiếng. Với mong muốn biến mắt kính thành phụ kiện đồng hành
                    hằng ngày của người dùng, thương hiệu luôn biết cách mang
                    đến trải nghiệm sử dụng hoàn hảo, nhờ vào chất liệu cao cấp
                    và công nghệ tiên tiến áp dụng trên gọng kính. Giờ đây, kính
                    mắt Molsion không đơn thuần chỉ là vật dụng dùng trong những
                    chuyến du lịch mà có thể đeo dạo phố, trà chiều hay vận động
                    ngoài trời.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_molsion" class="product-ordering" method="get">
