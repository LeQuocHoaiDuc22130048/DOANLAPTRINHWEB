          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    300+ Kính mát nữ, kính râm thời trang, hàng hiệu, chính hãng
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/kinh-mat-nu-thoi-trang-chinh-hang.jpg"
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Với bản sắc kiêu sa bóng bẩy cùng gam màu thời thượng, kính
                    mát nữ ngày nay không đơn thuần là vật dụng bảo vệ mắt mà
                    còn là phụ kiện không thể thiếu khi nói về thời trang. Dù
                    bạn đang sở hữu gương mặt ra sao thì sự đa dạng của các bộ
                    sưu tập mắt kính nữ cũng mang đến đến bạn sản phẩm ưng ý
                    giúp tôn mọi đường nét. Hãy chọn một chiếc kính mát phù hợp,
                    chúng sẽ trở thành “vũ khí” nâng tầm phong cách và sự lôi
                    cuốn cho chị em.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_mat_nu" class="product-ordering" method="get">
