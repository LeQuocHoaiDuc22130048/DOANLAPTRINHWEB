          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    300+ Gọng kính nhựa thời trang, cao cấp, chính hãng 100%
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner-gong-kinh-nhua.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Gọng kính nhựa là lựa chọn hàng đầu cho phong cách năng động
                    và trẻ trung. Chất liệu nhựa cao cấp từ Acetate đến TR90
                    mang đến cảm giác nhẹ nhàng, thoải mái khi đeo, đồng thời dễ
                    dàng điều chỉnh để phù hợp với mọi khuôn mặt. Từ gam màu
                    trung tính, thanh lịch đến những sắc màu rực rỡ, bắt mắt,
                    gọng kính cận nhựa cho phép bạn tự do thể hiện cá tính và gu
                    thẩm mỹ riêng. Bên cạnh đó, trọng lượng nhẹ và độ bền cao
                    khiến gọng kính nhựa trở thành lựa chọn lý tưởng cho hoạt
                    động hàng ngày.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                ...
                <form action="filter_nhua" class="product-ordering" method="get">
