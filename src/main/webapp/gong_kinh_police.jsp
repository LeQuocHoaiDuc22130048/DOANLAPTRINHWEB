          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Police chính hãng: Mẫu mới, giá bán, tư vấn mua
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_police_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính Police là sự lựa chọn hoàn hảo cho những ai yêu thích
                    phong cách mạnh mẽ, cá tính và hiện đại. Ra mắt vào năm 1983
                    đến từ Ý, kính mắt Police nổi tiếng với thiết kế đậm chất
                    thể thao, với những đường nét góc cạnh, mạnh mẽ. Không chỉ
                    chú trọng đến kiểu dáng, kính Police còn đặc biệt quan tâm
                    đến chất liệu nhằm đảm bảo trải nghiệm sử dụng tối ưu cho
                    người dùng. Từ kính mát đến kính thuốc, Police đều mang đến
                    những sản phẩm chất lượng, thời trang và phù hợp với nhiều
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_police" class="product-ordering" method="get">
