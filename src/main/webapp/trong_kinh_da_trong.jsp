          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Bảng giá kính đa tròng thế hệ mới dễ đeo, hợp mọi nhu cầu
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/trong-kinh-da-trong-chinh-hang.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính đa tròng là giải pháp hoàn hảo cho người suy giảm tầm
                    nhìn do lão hóa thị lực. Để khắc phục tình trạng khó chịu
                    cho đôi mắt ở tuổi trung niên, đa tròng ra đời, sở hữu 3
                    vùng nhìn (xa, gần, trung gian) cải thiện hình ảnh sắc nét,
                    rõ ràng như đôi mắt tinh tường lúc trẻ.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_da_trong" class="product-ordering" method="get">
