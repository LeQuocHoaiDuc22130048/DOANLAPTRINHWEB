...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Tròng kính rodenstock</title>
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Tròng kính Rodenstock (Đức) chính hãng: Giá bán, BH tốt nhất
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/trong-kinh-rodenstock-chinh-hang.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Rodenstock là thương hiệu tròng kính đến từ Đức với hơn 140 năm kinh nghiệm, nổi tiếng vì chất lượng cao cấp trong từng dòng kính, mang đến trải nghiệm cá nhân hóa tuyệt vời cho người sử dụng. Nhà sản xuất mang đến dòng kính chất lượng khớp với từng thông số và chuyển động mắt của người dùng. Điều này sẽ giúp bạn không còn nỗi lo trong việc khó thích nghi vì sự ưu việt trong công nghệ kính của thương hiệu sẽ khắc phục hoàn toàn vấn đề này.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_trong_rodenstock" class="product-ordering" method="get">
