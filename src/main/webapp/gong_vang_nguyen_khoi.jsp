          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Kính gọng vàng nguyên khối 18k, 24k cao cấp, chính hãng 100%
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/gong-kinh-vang-nguyen-khoi-chinh-hang.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Gọng kính vàng – Tuyệt tác vượt thời gian, biểu tượng của sự
                    sang trọng, đẳng cấp và quyền lực. Từ xa xưa, vàng đã được
                    xem là kim loại quý hiếm, đại diện cho sự giàu có và thịnh
                    vượng. Ngày nay, gọng kính vàng tiếp tục là lựa chọn hàng
                    đầu của giới thượng lưu, doanh nhân thành đạt và những người
                    yêu thích phong cách cổ điển, sang trọng. Vẻ đẹp lấp lánh,
                    ấm áp của vàng kết hợp với thiết kế tinh xảo, tỉ mỉ tạo nên
                    một tổng thể hoàn mỹ giúp bạn sẽ luôn tự tin tỏa sáng và
                    khẳng định đẳng cấp khác biệt.
                  </em>
                </p>
              </div>
              ...
              <p class="tag-in-category">
                ...
                <a href="" title="Gọng kính cận thể thao"> Gọng kim loại nam</a>
                <a href="" title="Gọng kính giá rẻ">Gọng nam trong suốt</a>
                <a href="" title="Gọng kính cận màu đen">Gọng nam không viền</a>
                <a href="" title="Gọng kính cận màu trắng">Gọng nam tròn</a>
                <a href="" title="Gọng kính cận màu nâu">Gọng nam giá rẻ</a>
              </p>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                ...
                <form action="filter_vang_nguyen_khoi" class="product-ordering" method="get">
...
<%--    <script src="assets/js/cart.js"></script>--%>
    ...
    <scripts src="assets/js/hien_thi_ten_dangnhap.js"></scripts>
