          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Cartier chính hãng: Giá, Tư vấn, Góp linh hoạt
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_brand/banner_cartier_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính Cartier là biểu tượng của sự sang trọng, tinh tế và
                    đẳng cấp. Thương hiệu Cartier nổi tiếng với thiết kế tinh
                    xảo, chất liệu cao cấp và sự tỉ mỉ trong từng chi tiết. Mỗi
                    chiếc kính Cartier đều là một tác phẩm nghệ thuật, thể hiện
                    sự kết hợp hoàn hảo giữa phong cách cổ điển và hiện đại. Từ
                    những mẫu kính gọng đồi mồi sang trọng đến những thiết kế
                    kim loại hiện đại, kính Cartier luôn toát lên vẻ đẹp vượt
                    thời gian. Logo “C” hai chữ cái lồng vào nhau đặc trưng của
                    Cartier không chỉ là dấu hiệu nhận biết thương hiệu mà còn
                    là biểu tượng của chất lượng và uy tín.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_cartier" class="product-ordering" method="get">
