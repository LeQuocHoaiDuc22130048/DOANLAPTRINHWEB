          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    RayBan Change: Bộ sưu tập gọng, kính mát đổi màu mới nhất
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_change.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    RayBan Change là bộ sưu tập gọng kính đổi màu mới nhất của
                    hãng. Với công nghệ được cấp bằng sáng chế, RayBan đã tạo ra
                    gọng kính nhạy sáng đầu tiên với sự kết hợp bởi Transitions
                    và Acetate chống thấm độc quyền. Với nhiều kiểu phối màu
                    cùng hoa văn độc đáo khi tiếp xúc với các mức độ ánh sáng
                    khác nhau, RayBan Change hứa hẹn là phiên bản không thể bỏ
                    qua.
                  </em>
                </p>
              </div>
              ...
              <p class="tag-in-category">
                ...
                <br />
                <a href="index.jsp" title="Mắt kính chính hãng"
                  >Mắt kính chính hãng</a
                >
                <a href="kinh_mat_tre_em.html" title="Kính mát trẻ em"
                  >Kính mát trẻ em</a
                >
              </p>
              ...
              <p class="tag-in-category">
                ...
                <a href="gong_kinh_chopard.html" title="Gọng kính Chopard"
                  >Chopard</a
                >
                <a href="gong_kinh_furla.html" title="Gọng kính Furla">Furla</a>
                <a href="gong_kinh_exfash.html" title="Gọng kính Exfash"
                  >Exfash</a
                >
                <a href="gong_kinh_parim.html" title="Gọng kính Parim">Parim</a>
                <a href="gong_kinh_eyescloud.html" title="Gọng kính EyesCloud"
                  >EyesCloud</a
                >
                ...
                <a href="gong_kinh_gucci.html" title="Gọng kính Gucci"
                  >Gọng Gucci</a
                >
                <a href="gong_kinh_burberry.html" title="Gọng kính Burberry"
                  >Gọng Burberry</a
                >
                <a href="gong_kinh_versace.html" title="Gọng kính Versace"
                  >Gọng Versace</a
                >
                <a href="gong_kinh_rayban.html" title="Gọng kính RayBan"
                  >Gọng RayBan</a
                >
                <a href="gong_kinh_oakley.html" title="Gọng kính Oakley"
                  >Gọng Oakley</a
                >
                <a href="gong_kinh_dior.html" title="Gọng kính Dior"
                  >Gọng Dior</a
                >
                <a href="gong_kinh_police.html" title="Gọng kính Police"
                  >Gọng Police</a
                >
              </p>
              <div class="productfilter-wc productfilter-woocommerce">

                <form action="filter_change" class="product-ordering" method="get">
