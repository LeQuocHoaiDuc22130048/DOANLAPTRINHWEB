          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính RayBan chính hãng: Mẫu mới, giá bán, BH 1 năm
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_rayban_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Thành lập vào năm 1937 tại Hoa Kỳ, kính RayBan trở thành
                    biểu tượng dành cho giới quân đội nhờ chất lượng và độ bền
                    bỉ hiếm thương hiệu nào có được. Đến nay, hãng vẫn là cây cổ
                    thụ vững chắc trong lĩnh vực kính, bởi bản sắc hiện đại và
                    cập nhật nhanh xu hướng. Dòng làm nên tên tuổi, được giới
                    ngôi sao ưa chuộng có thể kể đến như Rayban Aviator, RayBan
                    Clubmaster, Rayban Reverse. Đồng thời nhà mốt còn luôn dẫn
                    đầu xu thế và làm mới mình trong dòng kính râm đổi màu, kính
                    bảo vệ môi trường, kính mắt AI.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_rayban" class="product-ordering" method="get">
