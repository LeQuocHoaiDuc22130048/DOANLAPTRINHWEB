...
<head>
    ...
    <c:set var="titleName" value="Danh sách khuyến mãi" scope="request"/>
...
<div class="side-menu">
    ...
    <ul style="padding: 0">
        ...
        <li><a href="Promotion" class="active"><i class="fa-solid fa-percent"></i>Khuyến mãi</a></li>
...
<div class="container">
    ...
    <div class="content">
        <div class="btn_add_item">
            <a href="">
                <button class="btn btn-secondary">Thêm mã khuyến mãi</button>
            </a>
        </div>
