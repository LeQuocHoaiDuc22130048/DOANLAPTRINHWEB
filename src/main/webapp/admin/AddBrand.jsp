...
<head>
    ...
    <c:set var="titleName" value="Thêm thương hiệu" scope="request"/>
                ...
                <form id="addProductForm" enctype="multipart/form-data" method="post" >
                    ...
                    <div class="input-wrapper d-flex align-items-center mt-3">
                        ...
                        <div class="input-group w-50">
                            <input type="text" class="form-control" placeholder="Thương hiệu" aria-label="Thương hiệu"
                                   name="brandName">
                        </div>
                    </div>
                    <div class="line"></div>
                    ...
                    <div class="input-wrapper d-flex align-items-center mt-3">
                        ...
                        <div class="input-group w-50">
                            <input type="text" class="form-control" placeholder="Tiêu đề" aria-label="Tiêu đề"
                                   name="titleBrand">
                        </div>
                    </div>
                    <div class="line"></div>
                    ...
                    <div class="input-wrapper d-flex align-items-center mt-3">
                        ...
                        <div class="input-group w-50 form-floating">
                            <textarea class="form-control" placeholder="Mô tả sản phẩm" id="editor"
                                      name="descriptionBrand"></textarea>
                        </div>
                    </div>
                    <div class="line"></div>
                    ...
                    <div class="input-wrapper d-flex align-items-center mt-3">
                        ...
                        <div class="input-group w-50 d-grid">
                            ...
                            <label for="file-input" class="btn btn-primary rounded w-50">
                                <i class="fa-solid fa-upload"></i> &nbsp; Chọn icon
                            </label>
                    ...
                    <div class="input-wrapper d-flex align-items-center mt-3">
                        ...
                        <div class="input-group w-50">
                            <button type="submit" class="btn btn-primary me-3 rounded">Thêm thương hiệu</button>
