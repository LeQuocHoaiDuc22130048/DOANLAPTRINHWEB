    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 inf">
                ...
                <ul>
                    <li><a href="kinh_mat.jsp">Kính mát</a></li>
                    <li><a href="gong_kinh.jsp">Gọng kính</a></li>
                    <li><a href="trong_kinh.jsp">Tròng kính</a></li>
                    <li><a href="kinh_ap_trong.jsp">Kính áp tròng</a></li>
                </ul>
            </div>
            <div class="col-lg-3 inf">
                ...
                <ul>
                    ...
                    <li><a href="bai_viet.jsp">Đời sống</a></li>
            ...
            <div class="col-lg-3 inf">
                ...
                <ul>
                    ...
                    <li><a href="bai_viet.jsp">Bài viết</a></li>
                </ul>
            </div>
            <div class="col-lg-12">
