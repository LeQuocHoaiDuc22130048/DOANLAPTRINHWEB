          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Gọng kính cận nam đẹp: Mẫu mới, Giá, Tư vấn kiểu hợp mặt
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner-gong-kinh-can-nam.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Thời trang thịnh hành, gọng kính cận nam ngày nay cũng sở
                    hữu đa dạng mẫu mã và kiểu dáng hơn. Bởi là phụ kiện gắn
                    liền trên gương mặt nên yếu tố đẹp, xịn phải được đi đầu khi
                    lựa chọn. Hiểu rõ điều đó, các thương hiệu thời trang nổi
                    tiếng như Gucci, Dior, RayBan,…dần trình làng nhiều loại mắt
                    kính cận nam phù hợp với từng độ tuổi và phong cách, giúp
                    phái mạnh tự tin và lịch lãm hơn khi diện. Chất liệu chế tác
                    gọng kính cũng được đầu tư nhằm đem lại trải nghiệm sử dụng
                    tốt hơn, như kính nam titan, nhựa acetate, nhựa dẻo, vàng,
                    gỗ,…
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_nam" class="product-ordering" method="get">
                  <div
