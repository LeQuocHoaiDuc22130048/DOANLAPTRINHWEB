            ...
            <div class="col-12">
              <nav class="main-nav">
                ...
                <ul class="nav">
                  ...
                  <li class="scroll-to-section">
                    <a href="trong_kinh.html" class="active">Tròng kính</a>
                    <div class="sub-menu nav-dropdown">
                      <div id="col-142015409" class="col medium-6 large-6">
                        <div class="col-inner">
                          <div id="text-2480338525" class="text">
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Tròng kính hai tròng cao cấp, chính hãng 100%, BH 1 năm
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/kinh-hai-trong-chinh-hang-banner.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính hai tròng là loại tròng phổ biến dành cho người trung
                    niên hoặc lão thị. Sở hữu vùng nhìn ưu việt, tròng kính giúp
                    người đeo cải thiện khả năng quan sát hình ảnh ở xa và gần
                    sắc nét hơn. Việc sử dụng cặp kính lưỡng tiêu giúp chúng ta
                    tiết kiệm nhiều chi phí, bởi không cần phải cắt hai cặp kính
                    để nhìn xa và gần. Bên cạnh đó, thấu kính 2 tầm nhìn còn
                    được trang bị những lớp phủ tính năng đặc biệt giúp người sử
                    dụng giảm mỏi, chống lóa và hạn chế bụi bẩn hiệu quả
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_hai_trong" class="product-ordering" method="get">
