          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Kính áp tròng (Contact Lens) cận, loạn đẹp, chính hãng 100%
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/kinh-ap-trong-chinh-hang-banner.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính áp tròng – giải pháp điều chỉnh vấn đề tật khúc xạ phổ
                    biến. Chúng có thể thay thế kính thông thường bởi khả năng
                    cung cấp tầm nhìn như một đơn kính thuốc nhưng mang tính
                    thẩm mỹ vượt trội hơn. Sản phẩm như một lớp nhựa mỏng, trong
                    suốt nên khi tiếp xúc với mắt không có cảm như mình đang đeo
                    một chiếc kính quá nặng nề. Vì vậy, kính áp tròng là sự lựa
                    chọn hoàn hảo cho mọi hoạt động, mọi kiểu mặt và mọi phong
                    cách người dùng.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_ap_trong" class="product-ordering" method="get">
