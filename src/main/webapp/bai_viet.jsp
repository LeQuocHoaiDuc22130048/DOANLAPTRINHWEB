            ...
            <nav class="main-nav">
              ...
              <ul class="nav">
                <li class="scroll-to-section">
                  <a href="index.jsp#top">Trang chủ</a>
                </li>
                <li class="scroll-to-section">
                  <a href="kinh_mat.html">Kính mát</a>
                </li>
                <li class="scroll-to-section">
                  <a href="gong_kinh.html">Gọng kính</a>
                </li>
                <li class="scroll-to-section">
                ...
                <li class="submenu">
                  <a href="javascript:;" class="active">Trang phụ</a>
                  <ul>
  ...
  <div class="container">
        ...
        <div class="col-md-8">
           <div class="titlepage text-center">
              ...
              <p>Đôi mắt là tài sản quý giá, và kính mắt là phương tiện vừa bảo vệ vừa 
                 tô điểm cho vẻ đẹp của bạn. Blog của chúng tôi là nơi bạn có thể khám phá mọi điều về kính mắt – từ cách chọn lựa, bảo quản, đến cập nhật những xu hướng thời trang mới nhất. Hãy cùng chúng tôi khám phá!</p>
           </div>
        </div>
     </div>
     ...
     <div class="newBlog">
      ...
      <div class="blog-content">
        ...
        <a href="https://kinhmatanna.com/top-99-mon-qua-sinh-nhat-cho-nam-y-nghia-thiet-thuc-nhat" class="btn btn-read-more">Đọc thêm</a>
      </div>
    </div>
     ...
     <div class="row mt-4">
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <p>Khi tìm kiếm gọng kính lý tưởng, có ba tiêu chí quan trọng bạn cần xem xét: độ tương phản, tỷ lệ, và màu sắc của gọng.</p>
              <a href="https://matviet.vn/blogs/tu-van-chon-kinh/bi-quyet-chon-kinh-phu-hop-voi-khuon-mat" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <p>Thời đại công nghệ phát triển, mọi người tiếp xúc rất nhiều với các thiết bị điện tử dẫn đến tình trạng suy giảm thị lực.</p>
              <a href="https://matviet.vn/blogs/kien-thuc/anh-sang-xanh-la-gi-cach-bao-ve-mat-tranh-khoi-anh-sang-xanh" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <p>Thuốc nhỏ mắt là một giải pháp phổ biến để giải quyết các vấn đề liên quan đến mắt như khô mắt, nhức mỏi.</p>
              <a href="https://kinhmatanna.com/giai-dap-nho-thuoc-nho-mat-nhieu-co-tot-khong" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <p>Khám phá những mẫu kính mát nổi bật trong mùa hè năm nay để bảo vệ mắt và thêm phần phong cách.</p>
              <a href="https://www.elle.vn/fashion/kinh-mat-mua-he-hop-moi-khuon-mat" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://kinhmatbichngoc.vn/nhung-dieu-can-biet-ve-kinh-mat-chong-tia-uv.htm" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <p>Các loại kính cận và cách lựa chọn kính phù hợp với nhu cầu sử dụng hàng ngày. Bạn đã biết chưa?</p>
              <a href="https://matviet.vn/blogs/tu-van-chon-kinh/cac-loai-kinh-can-pho-bien-hien-nay" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://www.kinhmatdangquang.vn/tin-tuc/85/3-buoc-tong-ve-sinh-kinh-mat-dung-cach.html" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://mytour.vn/vi/blog/bai-viet/cach-ket-hop-trang-phuc-phu-hop-voi-tung-loai-kinh-giup-ban-tu-tin.html" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://chuyenxe.com/tho-va-xe/phu-kien/kinh-chong-bui-di-xe-may/" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://kinhhaitrieu.com/kinh-phan-cuc-la-gi-tac-dung-gi-cach-phan-biet" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://nhathuoclongchau.com.vn/bai-viet/nhung-thong-tin-can-biet-ve-kinh-2-trong.html" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://matkinhhoangha.com/huong-dan-chon-trong-kinh-can-tot-nhat-cho-mat-cua-ban/" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://buiphat.vn/kinh-xay-dung/kinh-dien-thong-minh.html" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://ankhangphat.com.vn/tin-tuc/mot-so-loi-ich-cua-trong-kinh-sieu-mong-ma-ban-nen-biet/" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
        ...
        <div class="col-md-4">
           <div class="blog-item">
              ...
              <a href="https://hellobacsi.com/nhan-khoa/cham-soc-mat/bo-tui-10-cach-chong-moi-mat-danh-cho-dan-van-phong" class="btn btn-read-more">Đọc thêm</a>
           </div>
        </div>
         <!-- Blog Item 16 -->
         <div class="col-md-4">
          <div class="blog-item">
             ...
             <p>Gọng kính hình bướm là một chiếc gọng có kiểu dáng mang phong cách độc đáo, được nhiều tín đồ thời trang săn lùng.</p>
             <a href="https://kinhmatanna.com/gong-kinh-hinh-buom-phong-cach-gong-kinh-doc-dao" class="btn btn-read-more">Đọc thêm</a>
          </div>
       </div>
<!-- Blog Item 17-->
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Nếu như bạn đang có thắc mắc rằng mặt oval có hợp đeo kính không thì câu trả lời là có thậm chí là còn rất thoải mái.</p>
     <a href="https://kinhmatanna.com/mat-oval-deo-kinh-gi-top-gong-kinh-phu-hop-nhat-voi-mat-oval" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
<!-- Blog Item 18-->
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Lens mắt màu xám khói là màu lens vô cùng đặc biệt, mang lại sự tinh tế và lịch lãm cho người đeo.</p>
     <a href="https://kinhmatanna.com/99-mau-lens-xam-khoi-dep-hot-nhat-hien-nay" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
...
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Trong thế giới thời trang kính mắt, gọng kính nhựa mix kim loại đang trở thành một xu hướng rất phổ biến.</p>
     <a href="https://kinhmatanna.com/huong-dan-chon-mua-gong-nhua-mix-kim-loai-dep-nhat" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
<!-- Blog Item 20-->
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Mẫu gọng kính đa giác với các góc cạnh sắc sảo sẽ giúp cho khuôn mặt trở nên thon gọn và hài hòa hơn.</p>
     <a href="https://kinhmatanna.com/kham-pha-nhung-dang-gong-kinh-da-giac-dep-nhat" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
<!-- Blog Item 21-->
<div class="col-md-4">
  <div class="blog-item">
    ...
    <p>Trái cây tốt cho mắt sẽ giúp bạn cải thiện thị lực và giảm nguy cơ mắc các bệnh liên quan đến mắt.</p>
     <a href="https://kinhmatanna.com/nhung-loai-trai-cay-nao-tot-cho-mat-top-9-loai-trai-cay-tot-cho-mat-nhat" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
<!-- Blog Item 22-->
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Ứng dụng Glassify – TryOn Virtual Glass mang đến trải nghiệm độc đáo cho người dùng khi chọn lựa kính mắt phù hợp với khuôn mặt</p>
     <a href="https://kinhmatanna.com/top-6-app-chon-kinh-phu-hop-voi-khuon-mat-chuan-nhat" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
<!-- Blog Item 23-->
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Ngày nay, tròng kính tráng gương trở thành một trong những phụ kiện thời trang được nhiều người chú ý không chỉ bởi thiết kế thời thượng mà còn với nhiều tính năng ưu việt.</p>
     <a href="https://kinhmatanna.com/trong-kinh-trang-guong-la-gi-ly-do-nen-su-dung" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
<!-- Blog Item 24-->
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Tròng kính Polaroid là loại tròng kính được thiết kế để loại bỏ hoặc giảm cường độ ánh sáng phản xạ và phân cực.</p>
     <a href="https://kinhmatanna.com/mat-kinh-trong-kinh-polaroid-la-gi-co-nen-mua-khong" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
...
<div class="col-md-4">
  <div class="blog-item">
     ...
     <a href="https://kinhmatanna.com/deo-kinh-khong-do-co-hai-mat-khong" class="btn btn-read-more">Đọc thêm</a>
  </div>
</div>
...
<div class="col-md-4">
  <div class="blog-item">
     ...
     <p>Mắt giúp con người có thể nhìn thấy mọi sự vật, sự việc và tận hưởng những khoảnh khắc đẹp trong cuộc sống.</p>
