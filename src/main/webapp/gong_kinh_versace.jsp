          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Versace chính hãng: Mẫu mới, giá bán, tư vấn mua
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_versace.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Versace gắn liền với dàn sao Hollywood “khủng” như Anne
                    Hathaway, Lily James, Lady Gaga, Miley Cyrus, Demi Moore,…
                    Sang trọng và lôi cuốn, cùng chất riêng trong thiết kế, mắt
                    kính Versace đem đến cho người dùng sức hút không thể cưỡng
                    lại. Sự kết hợp hài hòa giữa thiết kế thời trang sang trọng
                    và công nghệ hiện đại đã khiến kính Versace trở thành lựa
                    chọn ưu việt cho những ai yêu thích phong cách thời trang
                    tinh tế và đẳng cấp.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_versace" class="product-ordering" method="get">
