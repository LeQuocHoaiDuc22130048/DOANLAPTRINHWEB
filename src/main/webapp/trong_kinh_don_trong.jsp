        ...
        <div class="shop-container">
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              ...
              <p>
                <img
                  src="assets/images/kinh-don-trong-chinh-hang-banner.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính đơn tròng (Single Vision) là thấu kính một vùng nhìn
                    quen thuộc được sử dụng cho người mắc tật khúc xạ cận, viễn,
                    loạn thị. Đơn tròng mang đến tầm nhìn sắc nét ở khoảng cách
                    gần hoặc xa. Ngày nay, sản phẩm còn sở hữu công nghệ tiên
                    tiến đem đến tính năng vượt trội gồm chống chói, chống tia
                    UV và đặc biệt là lọc ánh sáng xanh thông minh. Điều này
                    giúp người dùng cải thiện khả năng nhận biết độ rõ nét của
                    vật thể, đồng thời bảo vệ thị lực do hạn chế được nguồn ánh
                    sáng độc hại.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_don_trong" class="product-ordering" method="get">
