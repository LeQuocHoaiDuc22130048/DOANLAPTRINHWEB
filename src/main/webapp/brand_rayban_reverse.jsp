          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Gọng, kính mát RayBan Reverse chính hãng 100%, góp 0%
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_reverse.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    RayBan Reverse là nước đi đầy táo bạo của thương hiệu, khi
                    lần đầu cho ra mắt dòng kính mát có thiết kế tròng lõm ngược
                    vào trong. Chúng không chỉ tăng tính thẩm mỹ mà còn tối ưu
                    tầm nhìn, bảo vệ đôi mắt người đeo toàn diện. Xem ngay phiên
                    bản độc đáo này từ nhà RayBan!
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                ...
                <form action="filter_reverse" class="product-ordering" method="get">
