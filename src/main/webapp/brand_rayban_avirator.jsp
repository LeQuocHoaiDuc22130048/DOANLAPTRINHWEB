          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Gọng, kính mát RayBan Aviator chính hãng 100%, góp 0%
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_avirator.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Bộ sưu tập RayBan Aviator ra mắt năm 1937, là một trong
                    những dòng bán chạy nhất và làm nên tên tuổi của hãng. Không
                    chỉ khuân đảo làn sóng điện ảnh Hollywood, thiết kế phi công
                    còn lan rộng ra toàn thế giới. Khám phá các mẫu kính RayBan
                    Aviator bán chạy mọi thời đại!
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                ...
                <form action="filter_avirator" class="product-ordering" method="get">
