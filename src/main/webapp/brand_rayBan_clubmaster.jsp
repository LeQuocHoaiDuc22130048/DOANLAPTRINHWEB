          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Gọng, kính mát RayBan Clubmaster chính hãng 100%, góp 0%
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_clubmaster.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    RayBan Clubmaster là lựa chọn hoàn hảo cho ai yêu thích thời
                    trang thanh lịch cổ điển. Với phần viền kính trên đậm, tạo
                    điểm nhấn cho đôi mắt người đeo. Thiết kế còn đa dạng màu
                    sắc và nhiều phiên bản, phù hợp mọi nhu cầu và phong cách.
                    Khám phá ngay các mẫu kính nửa viền của nhà RayBan dưới đây!
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_clubmaster" class="product-ordering" method="get">
