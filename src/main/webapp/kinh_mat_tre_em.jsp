            ...
            <div class="col-12">
              <nav class="main-nav">
                ...
                <ul class="nav">
                  ...
                  <li class="scroll-to-section">
                    <a href="kinh_mat.html" class="active">Kính mát</a>
          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Kính mát trẻ em thời trang, chống tia UV, bảo vệ mắt tối ưu
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_kinh_mat_tre_em.jpg" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính mát trẻ em là vật dụng thiết yếu để bảo vệ đôi mắt non
                    nớt của bé khỏi tác hại của tia UV. Chọn kính râm trẻ em cần
                    ưu tiên chất liệu an toàn, gọng nhẹ, dẻo dai, không kích ứng
                    và có khả năng chống trầy xước cao. Thiết kế kính cần ôm sát
                    khuôn mặt, vừa vặn và thoải mái để bé dễ dàng vận động.
                    Ngoài ra, kiểu dáng và màu sắc bắt mắt cũng sẽ giúp bé thích
                    thú hơn khi đeo kính. Hãy lựa chọn kính mát cao cấp đến từ
                    các thương hiệu nổi tiếngđể đảm bảo an toàn và sức khỏe cho
                    đôi mắt của trẻ.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_mat_tre_em" class="product-ordering" method="get">
...
<%--    <script src="assets/js/cart.js"></script>--%>
    ...
    <scrip src="assets/js/hien_thi_ten_dangnhap.js"></scrip>
