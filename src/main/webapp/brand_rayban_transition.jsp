          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Mắt kính Transition chính hãng: Mẫu mới, giá bán, tư vấn
                    mua,rẻ như ý
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_transition.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    (Đơn tròng) Essilor Transitions Signature Gen8 – Tròng kính
                    đổi màu nhanh nhất hiện nay – Thế hệ 2018, kính được thiết
                    kế với những chi tiết cầu kỳ, sang trọng. Từ những mẫu kính
                    mát đính kim cương lấp lánh đến những chiếc kính gọng vàng
                    sang trọng, Chopard luôn mang đến vẻ đẹp kiêu sa và quyến rũ
                    cho người sử dụng.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_transition" class="product-ordering" method="get">
