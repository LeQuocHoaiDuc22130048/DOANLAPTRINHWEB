          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    100+ Gọng kính trẻ em hàng hiệu, bền nhẹ, không kích ứng
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/banner-gong-kinh-can-tre-em-dep-chinh-hang.jpg"
                  alt=""
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Với các bé mắc tật khúc xạ, việc lựa chọn gọng kính trẻ em
                    phù hợp là vô cùng cần thiết. Chọn mắt kính cận cho bé cần
                    ưu tiên chất liệu an toàn, không gây kích ứng, đặc biệt là
                    nhẹ và dẻo dai như nhựa TR90, Acetate, Optyl. Hãy lựa chọn
                    các loại gọng kính cận trẻ em có kiểu dáng và màu màu sắc
                    bắt mắt cũng giúp bé thích thú và thoải mái hơn khi học tập
                    và vận động.
                  </em>
                </p>
              </div>
                ...
                <tbody>
                  <tr style="height: 95px">
                    <td style="width: 33, 3%; height: 95px; text-align: center">
                      <a title="Gọng kính nhua" href="gong_kinh_nhua.html">
                        <img
              ...
              <p class="tag-in-category">
                <strong>Ba mẹ nên chọn:</strong>
                <br />
                <a href="" title="Gọng kính Cartier">Gọng nhựa</a>
                <a href="" title="Gọng kính Montblanc">Gọng Acetate</a>
                <a href="" title="Gọng kính Bolon">Gọng dẻo TR90</a>
                <a href="" title="Gọng kính Chopard">Gọng Optyl</a>
                <a href="" title="Gọng kính Furla">Gọng Ultem</a>
              </p>
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_tre_em" class="product-ordering" method="get">
