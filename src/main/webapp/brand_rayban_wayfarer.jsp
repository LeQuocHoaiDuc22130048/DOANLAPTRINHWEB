          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Gọng, kính mát RayBan Wayfarer chính hãng 100%, góp 0%
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_wayfarer.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    RayBan Wayfarer là biểu tượng trong thời trang kính mát, ra
                    đời năm 1956 đến nay thiết kế chưa từng có dấu hiệu hạ
                    nhiệt. Với thiết kế vuông vức phù hợp cho mọi phong cách và
                    khuôn mặt. Xem ngay các mẫu kính Wayfarer kinh điển của nhà
                    RayBan.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_wayfarer" class="product-ordering" method="get">
