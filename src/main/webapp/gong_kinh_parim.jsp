          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    Kính mát, gọng kính Parim chính hãng: Giá bán, mẫu mới
                  </span>
                </strong>
              </h1>
              <p>
                <img src="assets/images/banner_parim_brand.jpg" alt="" />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Kính Parim đến từ Đài Loan là sự lựa chọn tuyệt vời cho
                    những ai tìm kiếm sự kết hợp giữa chất lượng, thiết kế và
                    giá cả hợp lý. Parim mang đến đa dạng các mẫu mã, từ kính
                    mát thời trang đến kính cận đáp ứng nhu cầu đa dạng của
                    người dùng. Thương hiệu này chú trọng đến chất lượng tròng
                    kính, đảm bảo bảo vệ mắt tối ưu khỏi tác hại của tia UV và
                    ánh sáng xanh. Thiết kế kính Parim thường theo xu hướng hiện
                    đại, trẻ trung, phù hợp với nhiều phong cách và khuôn mặt.
                    Đây là một thương hiệu đáng tin cậy cho những ai muốn sở hữu
                    một chiếc kính chất lượng mà không cần phải chi trả quá
                    nhiều.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_parim" class="product-ordering" method="get">
