          ...
          <div class="archive-product-wrap">
            <div class="container-banner-product">
              <h1 style="text-align: center">
                <strong>
                  <span>
                    300+ Kính mát nam, kính râm thời trang, đẹp, hàng hiệu 100%
                  </span>
                </strong>
              </h1>
              <p>
                <img
                  src="assets/images/kinh-mat-nam-chinh-hang-thoi-trang.jpg"
                />
              </p>
              <div class="text hide-for-small">
                <p class="caption-top">
                  <em>
                    Hơn 30 thương hiệu kính mát nam thời trang từ RayBan, Gucci,
                    Dior, Montblanc, Prada, Versace. Từ kiểu dáng phi công cổ
                    điển, thể thao năng động đến gọng vuông lịch lãm, kính râm
                    nam đáp ứng mọi phong cách và cá tính. Chất liệu gọng kính
                    đa dạng từ kim loại sang trọng, nhựa dẻo trẻ trung đến titan
                    cao cấp, kết hợp cùng tròng kính phân cực, chống chói, mang
                    đến tầm nhìn rõ nét và thoải mái. Mắt kính nam, không chỉ là
                    phụ kiện thời trang sành điệu, mà còn là “vệ sĩ” đắc lực bảo
                    vệ đôi mắt khỏi tác hại của tia UV.
                  </em>
                </p>
              </div>
              ...
              <div class="productfilter-wc productfilter-woocommerce">
                <form action="filter_mat_nam" class="product-ordering" method="get">
