...
@WebServlet(name = "ProductList_KMatNu", value = "/ProductList_KMatNu")
public class ProductList_KMatNu extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("kinh_mat_nu.jsp").forward(request, response);
