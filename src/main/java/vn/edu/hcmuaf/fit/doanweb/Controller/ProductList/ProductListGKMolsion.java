...
@WebServlet(name = "ProductListGKMolsion", value = "/ProductListGKMolsion")
public class ProductListGKMolsion extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_molsion.jsp").forward(request, response);
