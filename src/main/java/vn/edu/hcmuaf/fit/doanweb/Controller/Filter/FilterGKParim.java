...
@WebServlet(name = "FilterGKParim", value = "/filter_parim")
public class FilterGKParim extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("gong_kinh_parim.jsp").forward(request, response);
    }
