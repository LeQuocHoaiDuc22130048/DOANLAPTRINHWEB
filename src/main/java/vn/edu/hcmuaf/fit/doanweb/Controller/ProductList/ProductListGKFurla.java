...
@WebServlet(name = "ProductListGKFurla", value = "/ProductListGKFurla")
public class ProductListGKFurla extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_furla.jsp").forward(request, response);
