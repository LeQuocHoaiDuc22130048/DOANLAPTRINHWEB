...
@WebServlet(name = "FilterKinhApTrong", value = "/filter_ap_trong")
public class FilterKinhApTrong extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("filterMaterial", filterMaterial);
        request.setAttribute("filterGender", filterGender);
        request.setAttribute("filterColor", filterColor);
        request.setAttribute("filterShape", filterShape);
        request.setAttribute("filterBrand", filterBrand);
        request.setAttribute("filterCate", filterCate);
        request.setAttribute("filterPrice", filterPrice);

        request.getRequestDispatcher("kinh_ap_trong.jsp").forward(request, response);
    }
