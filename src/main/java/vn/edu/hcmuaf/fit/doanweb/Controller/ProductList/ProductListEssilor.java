...
@WebServlet(name = "ProductListEssilor", value = "/ProductListEssilor")
public class ProductListEssilor extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("trong_kinh_esilor.jsp").forward(request, response);
