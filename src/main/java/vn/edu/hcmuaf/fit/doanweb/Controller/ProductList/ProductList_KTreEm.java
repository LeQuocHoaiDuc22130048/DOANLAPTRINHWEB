...
@WebServlet(name = "ProductList_KTreEm", value = "/ProductList_KTreEm")
public class ProductList_KTreEm extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("kinh_mat_tre_em.jsp").forward(request, response);
