...
@WebServlet(name = "ProductListDonTrong", value = "/ProductListDonTrong")
public class ProductListDonTrong extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("kinh_da_trong.jsp").forward(request, response);
