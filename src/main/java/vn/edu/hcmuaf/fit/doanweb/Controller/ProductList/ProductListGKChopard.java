...
@WebServlet(name = "ProductListGKChopard", value = "/ProductListGKChopard")
public class ProductListGKChopard extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_chopard.jsp").forward(request, response);
