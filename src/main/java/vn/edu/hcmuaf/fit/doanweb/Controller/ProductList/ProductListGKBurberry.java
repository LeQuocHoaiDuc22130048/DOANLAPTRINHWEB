...
@WebServlet(name = "ProductListGKBurberry", value = "/gong_kinh_burberry")
public class ProductListGKBurberry extends HttpServlet {
            ...
            protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
                ...
                request.getRequestDispatcher("gong_kinh_burberry.jsp").forward(request, response);
