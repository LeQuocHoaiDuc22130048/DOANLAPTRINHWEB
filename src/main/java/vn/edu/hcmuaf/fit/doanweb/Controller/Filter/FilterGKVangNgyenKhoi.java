...
@WebServlet(name = "FilterGKVangNgyenKhoi", value = "/filter_vang_nguyen_khoi")
public class FilterGKVangNgyenKhoi extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("gong_kinh_vang_nguyen_khoi.jsp").forward(request, response);
    }
