...
@WebServlet(name = "FilterGKBolon", value = "/filter_gkbolon")
public class FilterGKBolon extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("gong_kinh_bolon.jsp").forward(request, response);
    }
