...
@WebServlet(name = "ProductListGKKimLoai", value = "/ProductListGKKimLoai")
public class ProductListGKKimLoai extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_kim_loai.jsp").forward(request, response);
