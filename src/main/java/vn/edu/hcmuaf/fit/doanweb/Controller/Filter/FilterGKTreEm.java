...
@WebServlet(name = "FilterGKTreEm", value = "/filter_tre_em")
public class FilterGKTreEm extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("gong_kinh_tre_em.jsp").forward(request, response);
    }
