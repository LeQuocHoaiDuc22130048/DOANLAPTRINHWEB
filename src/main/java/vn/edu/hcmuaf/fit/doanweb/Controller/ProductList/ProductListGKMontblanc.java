...
@WebServlet(name = "ProductListGKMontblanc", value = "/ProductListGKMontblanc")
public class ProductListGKMontblanc extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_montblanc.jsp").forward(request, response);
