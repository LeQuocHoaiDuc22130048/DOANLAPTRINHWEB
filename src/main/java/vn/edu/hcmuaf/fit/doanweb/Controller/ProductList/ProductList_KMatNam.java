...
@WebServlet(name = "ProductList_KMatNam", value = "/ProductList_KMatNam")
public class ProductList_KMatNam extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("kinh_mat_nam.jsp").forward(request, response);
