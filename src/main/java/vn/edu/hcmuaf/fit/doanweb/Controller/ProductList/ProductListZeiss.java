...
@WebServlet(name = "ProductListZeiss", value = "/ProductListZeiss")
public class ProductListZeiss extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("trong_kinh_zeiss.jsp").forward(request, response);
