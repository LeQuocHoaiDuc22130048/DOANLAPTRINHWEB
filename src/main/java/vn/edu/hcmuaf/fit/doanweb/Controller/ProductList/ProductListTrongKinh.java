...
@WebServlet(name = "ProductListTrongKinh", value = "/ProductListTrongKinh")
public class ProductListTrongKinh extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("trong_kinh.jsp").forward(request, response);
