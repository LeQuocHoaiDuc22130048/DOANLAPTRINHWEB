...
@WebServlet(name = "ProductListGKDaniel", value = "/ProductListGKDaniel")
public class ProductListGKDaniel extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_daniel_wellington.jsp").forward(request, response);
