...
@WebServlet(name = "ProductListGKRayBan", value = "/ProductListGKRayBan")
public class ProductListGKRayBan extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_rayban.jsp").forward(request, response);
