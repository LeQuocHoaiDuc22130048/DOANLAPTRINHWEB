...
@WebServlet(name = "ProductListGKEyescloud", value = "/ProductListGKEyescloud")
public class ProductListGKEyescloud extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_eyescloud.jsp").forward(request, response);
