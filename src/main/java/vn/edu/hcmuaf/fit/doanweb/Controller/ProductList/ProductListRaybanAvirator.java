...
@WebServlet(name = "ProductListRaybanAvirator", value = "/ProductListRaybanAvirator")
public class ProductListRaybanAvirator extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("brand_rayban_avirator.jsp").forward(request, response);
