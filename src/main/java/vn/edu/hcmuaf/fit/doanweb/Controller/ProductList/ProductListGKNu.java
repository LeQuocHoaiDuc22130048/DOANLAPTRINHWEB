...
@WebServlet(name = "ProductListGKNu", value = "/ProductListGKNu")
public class ProductListGKNu extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_nu.jsp").forward(request, response);
