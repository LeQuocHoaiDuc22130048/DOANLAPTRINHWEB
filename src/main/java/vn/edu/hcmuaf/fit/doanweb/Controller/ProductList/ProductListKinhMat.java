...
@WebServlet(name = "ProductListKinhMat", value = "/ProductListKinhMat")
public class ProductListKinhMat extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("kinh_mat.jsp").forward(request, response);
