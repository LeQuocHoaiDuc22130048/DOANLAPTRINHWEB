...
@WebServlet(name = "ProductListGKDior", value = "/ProductListGKDior")
public class ProductListGKDior extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_dior.jsp").forward(request, response);
