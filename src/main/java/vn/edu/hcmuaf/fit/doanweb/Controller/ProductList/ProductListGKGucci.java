...
@WebServlet(name = "ProductListGKGucci", value = "/ProductListGKGucci")
public class ProductListGKGucci extends HttpServlet {
            ...
            protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
                ...
                request.getRequestDispatcher("gong_kinh_gucci.jsp").forward(request, response);
