...
@WebServlet(name = "ProductListGKCartier", value = "/ProductListGKCartier")
public class ProductListGKCartier extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_cartier.jsp").forward(request, response);
