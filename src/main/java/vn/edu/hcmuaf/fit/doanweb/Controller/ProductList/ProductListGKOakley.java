...
@WebServlet(name = "ProductListGKOakley", value = "/ProductListGKOakley")
public class ProductListGKOakley extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_oakley.jsp").forward(request, response);
