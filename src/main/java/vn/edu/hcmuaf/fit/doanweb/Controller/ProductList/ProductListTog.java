...
@WebServlet(name = "ProductListTog", value = "/ProductListTog")
public class ProductListTog extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("trong_kinh_tog.jsp").forward(request, response);
