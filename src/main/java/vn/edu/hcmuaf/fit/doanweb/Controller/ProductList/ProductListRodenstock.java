...
@WebServlet(name = "ProductListRodenstock", value = "/ProductListRodenstock")
public class ProductListRodenstock extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("trong_kinh_rodenstock.jsp").forward(request, response);
