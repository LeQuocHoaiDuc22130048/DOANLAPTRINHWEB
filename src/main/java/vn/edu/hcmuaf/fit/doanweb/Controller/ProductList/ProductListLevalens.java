...
@WebServlet(name = "ProductListLevalens", value = "/ProductListLevalens")
public class ProductListLevalens extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("trong_kinh_Levalens.jsp").forward(request, response);
