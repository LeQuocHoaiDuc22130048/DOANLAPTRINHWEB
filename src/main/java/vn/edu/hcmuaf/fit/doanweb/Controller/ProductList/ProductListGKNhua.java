...
@WebServlet(name = "ProductListGKNhua", value = "/ProductListGKNhua")
public class ProductListGKNhua extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_nhua.jsp").forward(request, response);
