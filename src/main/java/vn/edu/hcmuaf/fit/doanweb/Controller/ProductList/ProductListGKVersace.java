...
@WebServlet(name = "ProductListGKVersace", value = "/ProductListGKVersace")
public class ProductListGKVersace extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            request.getRequestDispatcher("gong_kinh_versace.jsp").forward(request, response);
