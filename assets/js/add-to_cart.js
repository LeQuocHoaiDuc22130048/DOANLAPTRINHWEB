document.addEventListener("DOMContentLoaded", function () {
    ...
    if (addToCartButton) {
      addToCartButton.addEventListener("click", function (event) {
        ...
        const productPriceText = document.querySelector(".price .woocommerce-Price-amount").innerText;
        const productPrice = parseInt(productPriceText.replace(/[^\d]/g, "")) || 0;
        const quantityInput = document.querySelector(".quantity input.input-text");
